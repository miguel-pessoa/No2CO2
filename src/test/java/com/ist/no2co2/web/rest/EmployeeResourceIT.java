...
import com.ist.no2co2.domain.Employee;
import com.ist.no2co2.repository.EmployeeRepository;
...
public class EmployeeResourceIT {
    ...
    private static final Long DEFAULT_POINT_AMOUNT = 1L;
    private static final Long UPDATED_POINT_AMOUNT = 2L;
    ...
    public static Employee createUpdatedEntity(EntityManager em) {
        Employee employee = new Employee()
            ...
            .pointAmount(UPDATED_POINT_AMOUNT);
        return employee;
    }
    ...
    public void createEmployee() throws Exception {
        ...
        assertThat(testEmployee.getPointAmount()).isEqualTo(DEFAULT_POINT_AMOUNT);
    }
    ...
    public void getAllEmployees() throws Exception {
        ...
        restEmployeeMockMvc.perform(get("/api/employees?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].pointAmount").value(hasItem(DEFAULT_POINT_AMOUNT.intValue())));
    }
    ...
    public void getEmployee() throws Exception {
        ...
        restEmployeeMockMvc.perform(get("/api/employees/{id}", employee.getId()))
            ...
            .andExpect(jsonPath("$.pointAmount").value(DEFAULT_POINT_AMOUNT.intValue()));
    }
    ...
    public void updateEmployee() throws Exception {
        ...
        assertThat(testEmployee.getPointAmount()).isEqualTo(UPDATED_POINT_AMOUNT);
    }
