...
import { TripHistoryComponent } from 'app/entities/trip-history/trip-history.component';
...
describe('Component Tests', () => {
  describe('TripHistory Management Component', () => {
    let comp: TripHistoryComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(TripHistoryComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.tripHistories[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
